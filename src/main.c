 ...
 * Copyright (C) 2013-2015 Timothy Ward <gtwa001@gmail.com>
 *
...
static gboolean info_button_clicked_cb(GtkButton *button, gpointer user_data)
 {
    ...
    const gchar *copyright =  "Copyright © 2009-2010 Nikias Bassen, Martin Szulecki, 2013-2015 Timothy Ward; All Rights Reserved.";
...
=======
>>>>>>> e0546bc... Direct edit - update main.c
